...
export default function Home() {
  ...
  const { data, error, isLoading } = useSWR('/job', get_job)
  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta name="keywords" content="job Junction, job search, career opportunities, employment, job listings, job openings, job vacancies, job postings, hiring, recruitment" />
        <meta name="robots" content="index, follow" />
        <meta name="author" content="Abdullah Moiz" />
        <meta property="og:title" content="Find Your Dream Job | Job Junction Name" />
        <meta name="twitter:title" content="Find Your Dream Job | Job Junction Name" />
