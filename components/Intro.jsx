    ...
    <>
      <div className='w-full  h-full flex items-center lg:justify-start py-24 justify-center flex-wrap  '>
        <div className='lg:w-3/6 w-full sm:p-2 h-full my-2 flex items-center justify-center px-4 md:items-start md:justify-start md:p-20 flex-col '>
          ...
          <p className='md:text-lg sm:text-sm text-xs mb-20 text-gray-400'>Every day, 2400 people browse this platform, and 100 people post jobs on it!</p>
          <div className='bg-white flex-col mb-6 w-full md:px-4   py-4 flex sm:flex-row items-center justify-center'>
            ...
            <input onChange={(e) => setSearch(e.target.value)} type="text" placeholder='Explore job listings with job categories like Marketing...' className='xs:w-full w-3/4  h-full px-2 bg-gray-200 text-base py-3 outline-none' />
